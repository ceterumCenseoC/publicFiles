...
# Edelstein Effect for a Rashba Fermion: Mathematical Model and Analytical Framework
...
| HDR magnetization | $M_y = \frac{\mu_B\|e\|\tau}{2\pi}m\alpha\,[\hat{z}\times\mathbf{E}]_y$ | Gaiardoni et al. (2025), Eq. (8) |
| LDR magnetization | $M_y = \frac{\mu_B\|e\|\tau}{2\pi}\sqrt{m^2\alpha^2+2mE_F}\,[\hat{z}\times\mathbf{E}]_y$ | Gaiardoni et al. (2025), Eq. (9) |
